...
const ACTIVITY_HELP_CONTEXTS = Object.freeze({
	...
	equip: helpContext(
		"장비 · OHB/EQ/Stocker",
		"입출고 지점을 골라 장비 만들기",
		"장비가 화물을 주고받는 입출고 지점이 포트입니다. 레일 위 포트를 골라 장비를 만듭니다.",
		[
			[
				"OHB · 상부 보관",
				"레일 옆 포트 하나를 클릭하면 OHB가 생성됩니다. 같은 레일을 드래그해 여러 개를 배치할 수도 있습니다.",
			],
			[
				"EQ · 공정 장비",
				"같은 직선에서 시작 포트와 끝 포트를 차례로 클릭하면 EQ가 생성됩니다. 끝점을 확정하기 전 개수와 간격을 확인하세요. 드래그나 Enter도 사용할 수 있습니다.",
			],
			[
				"Stocker · 보관 장비",
				"포트 구성을 고르고 필요한 위치를 선택합니다. 개수와 오류를 확인한 뒤 Stocker 생성을 누르세요.",
			],
		],
	),
	inspect: helpContext(
