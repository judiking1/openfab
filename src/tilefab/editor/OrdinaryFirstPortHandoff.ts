...
export interface OrdinaryFirstPortHandoffPresentation {
	...
	readonly ariaLabel: "다음 작업: EQUIP에서 레일 옆 하늘색 원을 클릭하거나 Enter로 OHB Port 1개 놓기";
...
export function ordinaryRailCommitStatus(legalOhbSlotCount: number): string {
	...
	return legalOhbSlotCount > 0
		? "레일 구간을 건설했습니다 · 다음 레일은 빈 곳 어디서든 · Port는 EQUIP · 선택·복제는 INSPECT"
		: "레일 구간을 건설했습니다 · 다음 레일은 빈 곳 어디서든 · OHB Port용 내부 직선 슬롯이 없습니다 · 양끝 터미널 안전 구간을 제외할 수 있도록 직선을 더 늘리세요 · 선택·복제는 INSPECT";
}
