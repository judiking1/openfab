...
export const SYNTHETIC_FAB_STARTER_CERTIFIED_ARTIFACT_SCHEMA_VERSION = 7 as const;
export const SYNTHETIC_FAB_STARTER_CERTIFIED_ARTIFACT_ID = "large-fab-60.default.v7" as const;
export const PAIRED_CIRCULATION_FAB_STARTER_CERTIFIED_ARTIFACT_ID =
	"paired-circulation-fab-52.default.v8" as const;
export const FULL_FAB_STARTER_CERTIFIED_ARTIFACT_ID = "full-fab-52.default.v7" as const;
export const CENTRAL_SPINE_FAB_STARTER_CERTIFIED_ARTIFACT_ID =
	"central-spine-fab-24.default.v7" as const;
export const PARALLEL_HALL_FAB_STARTER_CERTIFIED_ARTIFACT_ID =
	"parallel-hall-fab-12.default.v7" as const;
export const PRODUCTION_FAB_STARTER_CERTIFIED_ARTIFACT_ID = "production-fab-60.default.v7" as const;
...
export const SYNTHETIC_FAB_STARTER_CERTIFICATION_ATTESTATION_SCHEMA_VERSION = 8 as const;
...
const CERTIFICATION_CONTRACT = "independent-materialization-v6" as const;
...
function checksumPayload(payloadText: string): string {
	const checksum = new OrderedTypedChecksum();
	checksum.addStrings(["synthetic-fab-certified-payload-v4", payloadText]);
	return checksum.digest();
}
...
function checksumCertification(
	...
	const checksum = new OrderedTypedChecksum();
	checksum.addStrings([
		"synthetic-fab-certified-evidence-v4",
		input.artifactId,
