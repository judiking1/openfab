...
const presetSpecifications = Object.freeze([
	Object.freeze({
		...
		artifactId: "paired-circulation-fab-52.default.v5",
		fileName: "paired-circulation-fab-52.default.v5.json",
		label: "Paired-Circulation Production FAB",
	}),
	Object.freeze({
		requestId: "full-fab-52",
		artifactId: "full-fab-52.default.v4",
		fileName: "full-fab-52.default.v4.json",
		label: "Full Production FAB",
	}),
	Object.freeze({
		requestId: "large-fab-60",
		artifactId: "large-fab-60.default.v4",
		fileName: "large-fab-60.default.v4.json",
		label: "Legacy Large FAB",
	}),
	Object.freeze({
		requestId: "parallel-hall-fab-12",
		artifactId: "parallel-hall-fab-12.default.v4",
		fileName: "parallel-hall-fab-12.default.v4.json",
		label: "Parallel Hall FAB",
	}),
	Object.freeze({
		requestId: "central-spine-fab-24",
		artifactId: "central-spine-fab-24.default.v4",
		fileName: "central-spine-fab-24.default.v4.json",
		label: "Central Spine FAB",
	}),
	Object.freeze({
		requestId: "production-fab-60",
		artifactId: "production-fab-60.default.v4",
		fileName: "production-fab-60.default.v4.json",
