...
const presetSpecifications = Object.freeze([
	Object.freeze({
		...
		fileName: "paired-circulation-fab-52.default.v4.json",
		label: "Paired-Circulation Production FAB",
	}),
	Object.freeze({
		requestId: "full-fab-52",
		artifactId: "full-fab-52.default.v3",
		fileName: "full-fab-52.default.v3.json",
		label: "Full Production FAB",
	}),
	Object.freeze({
		requestId: "large-fab-60",
		artifactId: "large-fab-60.default.v3",
		fileName: "large-fab-60.default.v3.json",
		label: "Legacy Large FAB",
	}),
	Object.freeze({
		requestId: "parallel-hall-fab-12",
		artifactId: "parallel-hall-fab-12.default.v3",
		fileName: "parallel-hall-fab-12.default.v3.json",
		label: "Parallel Hall FAB",
	}),
	Object.freeze({
		requestId: "central-spine-fab-24",
		artifactId: "central-spine-fab-24.default.v3",
		fileName: "central-spine-fab-24.default.v3.json",
		label: "Central Spine FAB",
	}),
	Object.freeze({
		requestId: "production-fab-60",
		artifactId: "production-fab-60.default.v3",
		fileName: "production-fab-60.default.v3.json",
